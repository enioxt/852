...
<!-- Kernel commit: c0b1586 | 2 rule section(s) changed -->
<!-- Kernel rules: ~/.claude/CLAUDE.md (always authoritative) -->
<!-- Re-run: bun ~/egos/scripts/disseminate-propagator.ts --all to update -->
<!-- + CAPABILITY_REGISTRY.md → ## 12b. INTELLIGENCE & INVESTIGATION (Intelink Harvest 2026-04-14) (20 lines) -->
<!-- + CAPABILITY_REGISTRY.md → ### Intelink Framework — Consultoria Track (6 lines) -->
