# UPSTREAM_KERNEL.md — 852 Inteligência
...
Este repo (`852`) é um **leaf** (anel R2) do ecossistema EGOS. Recebe propagação de governança via `disseminate-propagator.ts`.
...
- `README.md` — conteúdo específico de 852 Inteligência
...
bun scripts/disseminate-propagator.ts --repo /home/enio/852
```

## Contexto do repositório

**852 Inteligência** — Canal Anônimo para Policiais Civis de MG. Parte do ecossistema EGOS como produto de inteligência policial.

**Regras de integridade:**
- `R-SEC-002 [T0]`: dado real de investigação NUNCA sai da máquina
- `R-SEC-003 [T1]`: segurança é enforcement, não capacidade
