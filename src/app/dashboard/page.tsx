...
import { Bot, BarChart3, Users, AlertTriangle, TrendingUp, Search, Loader2 } from 'lucide-react';
...
export default function Dashboard() {
  ...
  // Chart data for lazy-loaded component
  const chartData = useMemo(() => ({
    issuesData,
    categoryData,
    timelineData
  }), [issuesData, categoryData, timelineData]);
        ...
        <Suspense fallback={
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="p-6 bg-slate-900 border border-slate-800 rounded-2xl h-80">
              <div className="h-full rounded-xl bg-slate-950 border border-slate-800 animate-pulse flex items-center justify-center">
          ...
          {showCharts && <ChartsModule data={chartData} />}
        </Suspense>
